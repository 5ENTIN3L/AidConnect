...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // AuthContext sets user → App.js will redirect based on role
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url('/login-hero.jpg')` }}></div>
                ...
                <div className="relative z-10 flex flex-col justify-between w-full h-full p-12">
                    ...
                    <div>
                        ...
                        <p className="text-blue-200 text-lg mb-10">Coordinating resources, preventing duplication, and ensuring transparent aid delivery.</p>
                    ...
                    <p className="text-blue-400 text-sm">© 2025 AidConnect. Securing humanitarian aid distribution.</p>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100 text-center">
                            <p className="text-sm text-gray-500">
                                ...
                                <span className="text-blue-600 font-semibold">Contact your NGO Admin</span>
                            </p>
                        </div>
                    </div>
                </div>
