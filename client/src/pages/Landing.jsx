...
function Landing() {
    ...
    // Inner Grid
    const innerImagesY = useTransform(scrollYProgress, [0, 1], ["-5vh", "0vh"]);
    const innerImagesYDown = useTransform(scrollYProgress, [0, 1], ["5vh", "0vh"]);
    const innerImagesXLeft = useTransform(scrollYProgress, [0, 1], ["-5vw", "0vw"]);
    const innerImagesXRight = useTransform(scrollYProgress, [0, 1], ["5vw", "0vw"]);

    // Outer Grid
    const outerImagesY = useTransform(scrollYProgress, [0, 1], ["-10vh", "0vh"]);
    const outerImagesYDown = useTransform(scrollYProgress, [0, 1], ["10vh", "0vh"]);
    const outerImagesXLeft = useTransform(scrollYProgress, [0, 1], ["-10vw", "0vw"]);
    const outerImagesXRight = useTransform(scrollYProgress, [0, 1], ["10vw", "0vw"]);
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-500 overflow-x-hidden text-slate-900 dark:text-white font-sans">
            ...
            {/* MAIN TEXT TITLE */}
            <section className="relative w-full pt-40 z-10 text-center px-4">
                <h1 className="max-w-5xl mx-auto text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight text-slate-900 dark:text-white drop-shadow-sm tracking-tight mb-12">
                    Transforming Humanitarian Relief with unprecedented transparency.
                </h1>
            </section>

            {/* Hero Section - Image Gallery */}
            <section ref={containerRef} className="relative w-full h-[80vh] min-h-[600px] flex items-center justify-center mb-32">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1400px] h-full flex items-center justify-center pointer-events-none">
                    ...
                    <motion.div
                        ...
                        className="absolute z-30 w-[90%] md:w-[800px] h-[350px] md:h-[500px] bg-cover bg-center shadow-[0_20px_50px_rgba(0,0,0,0.3)] origin-center pointer-events-auto"
                    >
                    ...
                    <motion.div
                        ...
                        className="absolute top-[0%] left-[8%] md:left-[15%] z-20 w-32 h-40 md:w-48 md:h-56 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none"
                    />
                    <motion.div
                        ...
                        className="absolute top-[5%] right-[8%] md:right-[15%] z-40 w-40 h-32 md:w-56 md:h-48 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none"
                    />
                    <motion.div
                        ...
                        className="absolute bottom-[0%] left-[10%] md:left-[20%] z-40 w-40 h-40 md:w-56 md:h-56 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none"
                    />
                    <motion.div
                    ...
                    <motion.div
                        ...
                        className="absolute top-[-5%] left-[2%] md:left-[5%] z-10 w-28 h-32 md:w-40 md:h-48 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none hidden md:block"
                    />
                    <motion.div
                        ...
                        className="absolute bottom-[-5%] right-[2%] md:right-[5%] z-20 w-28 h-28 md:w-40 md:h-40 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none hidden md:block"
                    />
                    <motion.div
                        ...
                        className="absolute top-[10%] right-[0%] md:right-[2%] z-10 w-32 h-32 md:w-48 md:h-48 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none hidden lg:block"
                    />
                    <motion.div
                        ...
                        className="absolute bottom-[10%] left-[0%] md:left-[5%] z-10 w-32 h-28 md:w-48 md:h-40 rounded-3xl bg-cover bg-center shadow-2xl ring-1 ring-white/10 pointer-events-none hidden lg:block"
                    />
                </div>
            </section>
